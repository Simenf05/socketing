...
class NextScreen(buttonFormat.ButtonFormat):
    ...
    """
    def __init__(self, x: int, y: int, w: int, h: int, screen, newScreen: str, text: None | str = None, activeButton: int = K_RETURN, color_: str | tuple = "white", bgcolor_: str | tuple = "black", fontSize: int = 32, width: int = 2) -> None:
